...
To write comments, use the latex environment ~hl~, for example write ~\hl{this is  a comment}~.
...
[[fig:ppc_km_sabio_blk]] shows the posterior predictive check graph for this model:
...
#  LocalWords:  Liebermeister RK Kms BLK Streamlit hypothesize
