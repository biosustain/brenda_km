...
This model can be expressed as the following program in the probabilistic programming language Stan program [cite:@carpenterStanProbabilisticProgramming2017]:
