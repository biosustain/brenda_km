...
\section{Method}
\label{sec:orged9da89}
\subsection{Data fetching}
\label{sec:orged7a9f2}
...
\label{sec:orge66fcab}
Figure \ref{fig:org45dd8d2} below shows our main model's marginal posterior
...
\caption{\label{fig:org45dd8d2}Marginal posterior predictive distributions for main model fit to SABIO Km data}
\end{figure}

In contrast figure \ref{fig:org80f5a54} are graphical posterior predictive checks for the really simple
and simple models.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./results/plots/ppc_km_sabio_enz_simple.png}
\caption{\label{fig:org80f5a54}Marginal posterior predictive distributions for simple and really simple models fit to SABIO Km data}
\end{figure}

\subsubsection{Cross validation}
\label{sec:orgb754a9c}
...
\label{sec:org960a2cc}
\section{Discussion}
\label{sec:orgcfc3d46}
\section{References}
\label{sec:orge89aaa4}
