...
\section{Method}
\label{sec:org78f5d5e}
\subsection{Data fetching}
\label{sec:org583062f}
...
\label{sec:org65e677b}
Figure \ref{fig:org9d62348} below shows our main model's marginal posterior
...
\caption{\label{fig:org9d62348}Marginal posterior predictive distributions for main model fit to SABIO Km data}
\end{figure}

Figures \ref{fig:org9e0149b} and \ref{fig:org387aabb} show
...
\caption{\label{fig:org9e0149b}Marginal posterior predictive distributions for simple model fit to SABIO Km data}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./results/plots/ppc_sabio-km-really-simple.png}
\caption{\label{fig:org387aabb}Marginal posterior predictive distributions for really simple model fit to SABIO Km data}
\end{figure}

From the continuous line of black dots in figure \ref{fig:org9e0149b} we can
...
In contrast figure \ref{fig:org387aabb} shows that the really simple
...
\subsubsection{{\bfseries\sffamily TODO} Cross validation}
\label{sec:org57d7028}
...
\hl{RESULTS OF CROSS VALIDATION COMPARISON}

\subsection{{\bfseries\sffamily DONE} Web app}
\label{sec:orga4f63ea}
...
most. The comparison in figure \ref{fig:org9d781a4} shows that the most important
...
\caption{\label{fig:org9d781a4}Comparison of hierarchical standard deviation parameters}
\end{figure}

Figure \ref{fig:org42ddc1d} compares the marginal distributions of km
...
\caption{\label{fig:org42ddc1d}Comparison of measured and modelled Km parameter distributions in BRENDA and SABIO-RK}
\end{figure}
...
model. Figure \ref{fig:org7c195f7} shows the results.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./results/plots/concentration_comparison.png}
\caption{\label{fig:org7c195f7}Comparison of model predictions with physiological metabolite concentrations from HMDB}
\end{figure}
...
seen in figure \ref{fig:org9d781a4}

\subsection{NADH vs NADPH}
\label{sec:org1ec26e0}

Figure \ref{fig:orga4246f3} shows histograms of measured Km parameters from the SABIO-RK
...
\caption{\label{fig:orga4246f3}Comparison of modelled and measured Km parameters for NADH and NADPH}
\end{figure}

\subsection{{\bfseries\sffamily TODO} Cofactor vs substrate}
\label{sec:org7111380}
...
\label{sec:org093574d}
\section{{\bfseries\sffamily TODO} Discussion}
\label{sec:org745f9fe}
\section{References}
\label{sec:orgf7cebe3}
