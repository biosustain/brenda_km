...
\section{Method}
\label{sec:org81472b6}
\subsection{Data fetching}
\label{sec:org2d7f969}
...
in figure \ref{fig:org81dd790}.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./results/plots/sd_priors_enz.png}
\caption{\label{fig:org81dd790}KDE plots of prior distributions for log-normal parameters}
\end{figure}
...
\caption{\label{fig:orgcd7bb6c}Marginal posterior predictive distributions for really simple model fit to SABIO Km data}
\end{figure}

From the continuous line of black dots in figure \ref{fig:orgb7e73ec} we can
...
In contrast figure \ref{fig:orgcd7bb6c} shows that the really simple
...
\ref{fig:orgd10c016} shows the posterior predictive check graph for this model:
...
\caption{\label{fig:orgd10c016}Marginal posterior predictive distributions for BLK model fit to SABIO Km data}
\end{figure}
...
The final model made slightly better out-of-sample predictions. The distribution of log likelihoods by posterior sample can be seen in figure \ref{fig:orgbb23632} below.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./results/plots/cv.png}
\caption{\label{fig:orgbb23632}Histograms of out-of-sample log likelihoods}
\end{figure}
...
most. The comparison in figure \ref{fig:orgb7bd88b} shows that the most important
...
\caption{\label{fig:orgb7bd88b}Comparison of hierarchical standard deviation parameters}
\end{figure}

Figure \ref{fig:orgdad634e} compares the marginal distributions of km
...
\caption{\label{fig:orgdad634e}Comparison of measured and modelled Km parameter distributions in BRENDA and SABIO-RK}
\end{figure}
