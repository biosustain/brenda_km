...
\section{Method}
\label{sec:orgb68824a}
\subsection{Data fetching}
\label{sec:orgcc0ecb4}
...
in figure \ref{fig:org777eb93}.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./results/plots/sd_priors_enz.png}
\caption{\label{fig:org777eb93}KDE plots of prior distributions for log-normal parameters}
\end{figure}
...
\caption{\label{fig:org5edb4ec}Marginal posterior predictive distributions for really simple model fit to SABIO Km data}
\end{figure}

From the continuous line of black dots in figure \ref{fig:org976ad80} we can
...
In contrast figure \ref{fig:org5edb4ec} shows that the really simple
...
Overall these graphical posterior predictive checks made us confident that our model was achieving a qualitatively satisfactory balance between overfitting and underfitting. However, from graphical posterior predictive checks it was not easy to distinguish our final model from the BLK model. Figure \ref{fig:org34bdfa4}
...
\caption{\label{fig:org34bdfa4}Marginal posterior predictive distributions for BLK model fit to SABIO Km data}
\end{figure}
...
The final model made slightly better out-of-sample predictions. The distribution of log likelihoods by posterior sample can be seen in figure \ref{fig:org758fc32} below.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./results/plots/cv.png}
\caption{\label{fig:org758fc32}Histograms of out-of-sample log likelihoods}
\end{figure}
...
most. The comparison in figure \ref{fig:orgb52286b} shows that the most important
...
\caption{\label{fig:orgb52286b}Comparison of hierarchical standard deviation parameters}
\end{figure}

Figure \ref{fig:orgba68f81} compares the marginal distributions of km
...
\caption{\label{fig:orgba68f81}Comparison of measured and modelled Km parameter distributions in BRENDA and SABIO-RK}
\end{figure}
