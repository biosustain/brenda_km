...
\section{Method}
\label{sec:org605976c}
\subsection{Data fetching}
\label{sec:org3d25f90}
...
in figure \ref{fig:org304b949}.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./results/plots/sd_priors_enz.png}
\caption{\label{fig:org304b949}KDE plots of prior distributions for log-normal parameters}
\end{figure}
...
\label{sec:org4a04c1f}
Figure \ref{fig:org626fb1d} below shows our main model's marginal posterior
...
\caption{\label{fig:org626fb1d}Marginal posterior predictive distributions for main model fit to SABIO Km data}
\end{figure}

Figures \ref{fig:org570e7fb} and \ref{fig:orgbfddfe3} show
...
\caption{\label{fig:org570e7fb}Marginal posterior predictive distributions for simple model fit to SABIO Km data}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./results/plots/ppc_sabio-km-really-simple.png}
\caption{\label{fig:orgbfddfe3}Marginal posterior predictive distributions for really simple model fit to SABIO Km data}
\end{figure}

From the continuous line of black dots in figure \ref{fig:org570e7fb} we can
...
In contrast figure \ref{fig:orgbfddfe3} shows that the really simple
...
Overall these graphical posterior predictive checks made us confident that our model was achieving a qualitatively satisfactory balance between overfitting and underfitting. However, from graphical posterior predictive checks it was not easy to distinguish our final model from the BLK model. Figure \ref{fig:orge1490d5}
...
\caption{\label{fig:orge1490d5}Marginal posterior predictive distributions for BLK model fit to SABIO Km data}
\end{figure}
...
\subsubsection{Cross validati}
\label{sec:org666e20c}
...
The final model made slightly better out-of-sample predictions. The distribution of log likelihoods by posterior sample can be seen in figure \ref{fig:orgdbd4e2d} below.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./results/plots/cv.png}
\caption{\label{fig:orgdbd4e2d}Histograms of out-of-sample log likelihoods}
\end{figure}
...
most. The comparison in figure \ref{fig:orgc30fb62} shows that the most important
...
\caption{\label{fig:orgc30fb62}Comparison of hierarchical standard deviation parameters}
\end{figure}

Figure \ref{fig:org8ebf498} compares the marginal distributions of km
...
\caption{\label{fig:org8ebf498}Comparison of measured and modelled Km parameter distributions in BRENDA and SABIO-RK}
\end{figure}
...
model. Figure \ref{fig:org59254d8} shows the results.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./results/plots/concentration_comparison.png}
\caption{\label{fig:org59254d8}Comparison of model predictions with physiological metabolite concentrations from HMDB}
\end{figure}
...
seen in figure \ref{fig:orgc30fb62}

\subsection{NADH vs NADPH}
\label{sec:orgb9021ce}

Figure \ref{fig:orgb28d979} shows histograms of measured Km parameters from the SABIO-RK
...
\caption{\label{fig:orgb28d979}Comparison of modelled and measured Km parameters for NADH and NADPH}
\end{figure}

\subsection{Cofactor vs substrate}
\label{sec:org26c3ec5}
...
Figure \ref{fig:org30a85d3} shows the 1\%-99\% posterior intervals for substrate
...
\caption{\label{fig:org30a85d3}Comparison of modelled and measured Km parameters for NADH and NADPH}
\end{figure}

Figure \ref{fig:org875fc6c} shows, for each reaction for which both a
...
\caption{\label{fig:org875fc6c}Comparison of modelled and measured Km parameters for NADH and NADPH}
\end{figure}

\subsection{Which results to use?}
\label{sec:orge9e6b7f}
...
\label{sec:org39443a4}
\section{{\bfseries\sffamily TODO} Discussion}
\label{sec:org987bc3d}
\section{References}
\label{sec:orgdd8d6ae}
